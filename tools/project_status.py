...
PARTS: tuple[Part, ...] = (
    ...
    Part("Профиль и два хеша", ("core/profile.py", "core/settings.py"),
         ...
         "125 настроек: единицы, границы, форк журнала"),
    ...
    Part("Граф мест", ("model/places.py",), ("place", "graph", "route"),
         "без координат, маршрут по измеренному времени"),
...
MISSING: tuple[tuple[str, str], ...] = (
    ...
    ("Планы длиннее двух шагов",
     "отпечаток вида склеивает разные состояния мира: 0 из 13 доходят"),
